...
{
    /// <summary>
    /// Color-independent design tokens: spacing scale, border radius policy, and typography.
    /// These are constants shared by EVERY control. Color decisions live in
    /// <see cref="VibeAlarmPalette"/> (fixed base tokens + the live accent); this type
    /// intentionally holds no color values so nothing can be bypassed through it.
    /// </summary>
