...
namespace VibeAlarm.Services
{
    ...
    public sealed class AudioService : IDisposable
    {
        ...
        private string? activeAmbientName;
        ...
        /// <summary>The display name of the playing ambient track, or null when stopped.</summary>
        public string? ActiveAmbientName => activeAmbientAlias != null ? activeAmbientName : null;
